    ...
    var useCaseConfig = {
      ...
      'correlation': {
        ...
        sub: 'Consolidated NMHF Database · Tableau Public',
        icon: 'bi-diagram-3',
        src: 'https://public.tableau.com/views/ConsolidatedSocialDeterminantsofHealthDatabase/CorrelationDashboard?:showVizHome=no&:embed=yes&:tabs=no&:toolbar=yes&:device=desktop'
      },
      'data-structure': {
